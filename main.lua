...
function SendNotification(text)
    Notification:Notify(
        {Title = "angled.cc | paid", Description = "Big balls energy - "..text},
...
do
	local Window = library:AddWindow("angled.cc | paid", {
